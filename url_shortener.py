...
def surl_cc(url, filename=None):   
    ssur_cc_key_list = ['nZ9ZzSa4LZ4o', 'Ed8nLSFpNVGB', 'YJimrVqxmExf','L9YRXGPugtet', 'HR7RDeKNVgTX', 'RKqh9qcjDoe4', 'XoWtP22exnmy', 'GGFedvn7yhFZ', 'yJpFtTfXNZVi', 'MqQsBMbCvthf', 'MqQsBMbCvthf', 'vMd8zBusHzKk', 'ZYhVdSnyyEH6', '4XKRnpnNEUYX', '84zd7S9HP7CF', 'PtpgRsxM5ozh']
...
def short_88nb_cc(url):   
    short_88nb_cc_key_list = ['ea8d7b3ded', 'b89377c881', 'b6fc6a3133', '44ccb4f4b2', '120ef9330f']
